...
resource "aws_security_group" "default_sg_for_vpc_endpoint" {
  ...
  ingress {
    ...
    to_port     = 443
    protocol    = "tcp"
    cidr_blocks = flatten([[aws_vpc.main.cidr_block], var.secondary_cidr_block != null ? [var.secondary_cidr_block] : [], var.additional_cidr_block != null ? var.additional_cidr_block : [] ])
